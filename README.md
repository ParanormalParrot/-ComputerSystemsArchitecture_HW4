...
## Выходные данные 
Прогррамма выоводит сообщения о перелвижении групп пиратов по острову и о том, удалось ли  найти клад на этом участке. В конце работы выводится сообщение о том, какая по счёту группа нашда клад, на каком по счёту участке в каких координатах.
...
-Остров Сокровищ представляет собой массив
